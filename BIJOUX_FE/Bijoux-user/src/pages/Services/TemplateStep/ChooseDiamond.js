...
export default function ChooseDiamond() {
    ...
    const model =
    {
        ...
        model_diamond_shape: [
            ...
            },
            {
                id: 2,
                name: "Oval",
                drawingPath: "M 10.1 1.001 c 2.95 0.083 5.287 3.735 5.233 8.148 S 12.852 17.08 9.9 16.999 S 4.614 13.265 4.668 8.85 S 7.148 0.92 10.1 1.001 Z M 13.559 14.73 H 11.542 l -1.406 2.128 c 1.32 -0.051 2.52 -0.848 3.423 -2.128 Z m -5.099 0 H 6.441 c 0.908 1.288 2.122 2.09 3.462 2.129 l -0.039 -0.002 L 8.46 14.73 Z M 10 13.78 l -1.413 0.896 l 1.414 2.139 l 1.412 -2.14 Z m 3.613 -2.292 l -1.432 0.909 l -0.59 2.19 h 2.022 Z m -7.225 0 v 3.099 h 2.02 l -0.588 -2.19 Z m 1.599 1.015 l 0.55 2.042 l 1.333 -0.847 Z m 4.026 0 L 10.13 13.698 l 1.334 0.847 Z M 4.801 9.192 c 0.032 2.037 0.58 3.887 1.454 5.258 v -3.058 Z m 10.398 0 l -1.453 2.2 v 3.058 c 0.878 -1.377 1.428 -3.24 1.454 -5.303 Z m -5.2 -4.824 L 7.926 5.664 L 7.038 8.97 l 0.896 3.334 L 10 13.617 l 2.067 -1.312 l 0.896 -3.333 l -0.887 -3.308 Z m -3.03 4.86 l -0.566 2.107 l 1.364 0.865 Z m 6.063 0.002 l -0.798 2.969 l 1.363 -0.864 Z M 6.298 6.735 L 4.813 8.963 l 1.485 2.249 l 0.601 -2.24 Z m 7.405 0 L 13.1 8.973 l 0.601 2.24 l 1.486 -2.249 Z m 0.042 -3.185 v 3.006 l 1.453 2.178 c -0.044 -2.007 -0.588 -3.83 -1.453 -5.184 Z m -7.49 0 C 5.377 4.927 4.827 6.79 4.8 8.854 l 0.002 -0.12 l 1.452 -2.178 Z m 1.504 2.217 l -1.355 0.847 l 0.564 2.1 Z m 4.482 0 l 0.79 2.947 l 0.566 -2.1 Z m -3.85 -2.355 H 6.388 V 6.46 l 1.424 -0.889 Z m 5.222 0 H 11.609 l 0.58 2.16 l 1.424 0.888 Z m -5.092 0.032 l -0.544 2.023 L 9.87 4.286 Z m 2.959 0 l -1.349 0.841 l 1.892 1.182 Z M 10 1.184 L 8.578 3.316 L 10 4.204 l 1.422 -0.888 Z m 0.137 -0.04 L 11.556 3.27 h 2.003 C 12.65 1.983 11.437 1.18 10.097 1.143 Z m -0.273 0 c -1.318 0.05 -2.52 0.848 -3.422 2.127 h 2.003 l 1.419 -2.128 Z"
            },
            {
                id: 3,
                name: "Princess",
            ...
            },
            {
                id: 4,
                name: "Heart",
                drawingPath: "M 12.66 0.693 c 0.934 -0.261 1.718 -0.25 2.659 -0.007 c 1.119 0.29 2.007 0.999 2.538 2.298 c 0.475 1.162 0.439 2.752 0.003 4.302 c -0.444 1.579 -1.142 2.877 -2.15 4.041 q -0.691 0.797 -1.48 1.494 l -0.006 0.089 l -0.077 0.066 l -0.084 -0.009 q -0.87 0.75 -1.827 1.389 a 17 17 0 0 1 -1.515 0.9 l -0.176 0.09 l -
z m -4.189 0.865 l -1.495 0.451 l 1.498 0.858 l 1.354 -0.786 Z m 4.05 -0.859 l -2.36 1.353 l 2.318 0.773 Z m -8.131 -0.001 v 2.122 L 8.4 4.29 Z M 12.677 0.874 L 10.364 3.77 l 1.386 0.535 l 2.473 -1.416 Z m -4.953 0 L 6.191 2.87 l 2.383 1.357 l 1.545 -0.466 Z m -3.54 0.327 c -0.641 0.376 -1.158 0.97 -1.512 1.838 c -0.143 0.359 -0.238 0.736 -0.284 1.12 l 3.595 -1.305 Z m 12.056 0.015 l -1.795 1.648 l 3.568 1.295 a 4.6 4.6 0 0 0 -0.244 -1.017 l -0.04 -0.103 c -0.35 -0.858 -0.859 -1.447 -1.489 -1.823 Z M 12.482 0.895 q -0.275 0.092 -0.608 0.234 q -0.227 0.097 -0.472 0.213 c -0.278 0.13 -0.557 0.272 -0.823 0.412 l -0.194 0.104 l -0.151 0.083 h -0.068 l -0.093 -0.052 l -0.252 -0.135 a 20 20 0 0 0 -0.823 -0.413 a 14 14 0 0 0 -0.472 -0.212 a 9 9 0 0 0 -0.6 -0.232 l 2.32 2.797 Z M 15.16 0.79 c -0.863 -0.206 -1.595 -0.205 -2.463 0.038 l 0.1 -0.028 l 1.524 1.987 l 1.791 -1.645 a 3.6 3.6 0 0 0 -0.736 -0.296 l -0.091 -0.025 Z m -7.557 0.01 C 6.737 0.575 6 0.594 5.116 0.822 q -0.42 0.107 -0.804 0.308 l 1.782 1.636 Z"
            },
            {
                id: 5,
                name: "Cushion",
    ...
    const [diamond_shape, setDiamond_shape_id] = useState(model.model_diamond_shape[0]);
    ...
    useEffect(() => {
        ...
        const mountingType = localStorage.getItem('mountingType');

        if (finalProduct) {
            const model_id = query.get("model_id");
            setDiamond_shape_id(finalProduct.diamond_shape || model.model_diamond_shape[0]);
            setDiamond_size(finalProduct.diamond_size || null);
            setDiamond_origin_id(finalProduct.diamond_origin || null);
            setDiamond_clarity_id(finalProduct.diamond_clarity || null);
            setDiamond_color_id(finalProduct.diamond_color || null);
            setDiamond_cut_id(finalProduct.diamond_cut || null);
            setDiamondImage(finalProduct.diamond_imageUrl || diamondImg);
            setCheckOpenEdit(true);
            console.log(diamond_origin)

            if (finalProduct.model) {
                navigate(`/mounting-detail/${finalProduct.model.id}`);
            } else if (mountingType) {

                window.location.href = '/template?step=1&mountingType=' + mountingType
            } else {
    ...
    const handleSelectDiamond = () => {
        ...
        finalProduct.diamond_imageUrl = finalDiamond.imageUrl;
                            ...
                            <div className="w-2/3">
                                ...
                                <div className="flex w-full grid-cols-3 gap-2 ml-5 text-xs">
                                    ...
                                    <div className="flex-1">
                                        <p>Diamond Shape: {diamond.Is_editable ? diamond_shape.name : diamond.diamond_shape[0].name}</p>
                                    </div>
                                </div>
                            </div>
                            {diamond.Is_editable && (
                                    ...
                                    {model.model_diamond_shape.map((shape, index) => (
                                        <div id={index} onClick={() => handleShapeChange(shape)}
                                            className={
                                                ...
                                                (diamond_shape.id === shape.id ? " border-2 border-black rounded-lg" : "")
                                            }
                                        >

...
export default function MountingDetail() {
    ...
    const [sideMetal, setSideMetal] = useState(null); //biến state lưu id của kim loại Side
    ...
    const handleSelectModel = () => {
        ...
        setFinalModel(finalModel);
        localStorage.setItem('finalProduct', JSON.stringify(finalModel)); //LƯU THÔNG TIN VÀO LOCAL STORAGE

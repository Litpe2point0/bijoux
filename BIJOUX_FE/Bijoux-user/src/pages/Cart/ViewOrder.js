...
import OrderCard from "../../components/Cart/Quotes/orderCard";
...
export default function ViewOrder() {
    ...
    const customizationOrderList = orderList.filter(order => order.order_type.name === "Customization");
    const templateOrderList = orderList.filter(order => order.order_type.name === "Template");

...
import { templateBanner, et_1, et_2, et_3, et_4, ring, band, pendant } from "../../assets/images";
            ...
            <div class="w-full lg:h-full md:h-full xs:h-full bg-cover bg-center flex flex-col">
                <div className="flex flex-col m-10 items-center ">
                    ...
                    <div className="w-full grid md:grid-cols-2 sm:grid-cols-1 mt-5 mb-10 gap-3">
                        <div className="w-full flex flex-col justify-center items-end md:order-1 sm:order-2">
                            <p className="md:text-lg sm:text-sm text-start md:w-[624px] sm:w-full font-gantariFont text-gray-400 mt-2 mb-5">
                                Choose from our extensive collection of templates to create stunning jewelry pieces. Our pre-designed options offer a blend of elegance and affordability, perfect for any occasion.
                            </p>
                            <div className="md:w-[624px] sm:w-full flex md:justify-start sm:justify-center">
                                <button onClick={handleOpen} className="bg-[#151542] hover:bg-cyan-900 w-36 text-white pl-5 pr-5 pt-2 pb-2 rounded-sm">
                                    Get Started
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex justify-around w-full gap-5">
                        ...
                        <div className="w-[330px] md:h-[400px] sm:h-[480px] overflow-hidden shadow-lg hover:bg-slate-100">
                            <img
                                src={et_3}
                                alt="Ảnh"
                                className="w-full md:h-[260px] sm:h-[128px] object-cover"

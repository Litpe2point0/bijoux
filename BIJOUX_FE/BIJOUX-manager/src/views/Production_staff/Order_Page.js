...
import { get_assigned_orders_production } from "../../api/main/orders/Order_api";
          ...
          return (
            ...
            <CButtonGroup style={{ width: '100%', height: "100%" }} role="group" aria-label="Basic mixed styles example">
              <Modal_Button
                ...
                context={ProductionOrderPageContext}
...
const Order_Page = () => {
  ...
  const handleDataChange = async () => {
    ...
    const orderList = await get_assigned_orders_production();;

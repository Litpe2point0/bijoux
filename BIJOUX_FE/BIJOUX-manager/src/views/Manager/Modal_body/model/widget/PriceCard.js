...
const PriceCard = ({ model, handleChange }) => {
    const [profitRate, setProfitRate] = useState(model ? model.profit_rate : 0)
    const [productionPrice, setProductionPrice] = useState(model ? model.production_price : 0)
